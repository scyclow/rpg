export const billingCSNodes = {
  ...
  sptxInstructions2b: {
    text: `Once you have funded your Pay App balance with ${Math.floor(globalState.ispBalance)}., Dollars., And., ${100*(globalState.ispBalance % 1)}., Cents., please select the. SEND. Option from the drop down menu. Once you have selected the. SEND. Option from the drop down menu press 1., To repeat this message press 2., To go back press 3., To dispute your unpaid balance press 4., To go back to the main menu press 5`,
    handler: options({
      1: 'sptxInstructions3',
      2: 'sptxInstructions2b',
      3: 'sptxInstructions2',
      4: 'disputeBalance',
      5: 'mainMenu'
    })
  ...
  sptxInstructions3: {
    text: `Once you have selected the. SEND. Option from the drop down menu, please enter, ${Math.floor(globalState.ispBalance)}., Dollars., And., ${100*(globalState.ispBalance % 1)}., Cents., into the send amount input box. Once you have entered, ${Math.floor(globalState.ispBalance)}., Dollars., And., ${100*(globalState.ispBalance % 1)}., Cents., into the send amount input box press 1., To repeat this message press 2., To go back press 3., To dispute your unpaid balance press 4., To go back to the main menu press 5`,
    handler: options({
      1: 'sptxInstructions4',
      2: 'sptxInstructions3',
      3: 'sptxInstructions2b',
      4: 'disputeBalance',
      5: 'mainMenu'
    })
  },
